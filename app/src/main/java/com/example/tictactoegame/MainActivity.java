...
import java.util.List;
 public class MainActivity extends AppCompatActivity {
     ...
     private ImageView image1,image2,image3,image4,image5,image6,image7,image8,image9,playerTwoSelection,playerOneSelection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerTwoSelection=findViewById(R.id.playerTwoSelection);
        playerOneSelection=findViewById(R.id.playerOneSelection);
    ...
    private void changePlayerTurn(int currentPlayerTurn){
        ...
        if (playerTurn==1){
            playerOneLayout.setBackgroundResource(R.drawable.red_indicator);
            playerTwoLayout.setBackgroundResource(R.drawable.back_drop);
        }
        else {
            playerOneLayout.setBackgroundResource(R.drawable.back_drop);
            playerTwoLayout.setBackgroundResource(R.drawable.yellow_indicator);
        }
